function [p_t, c_t, p, p_r, e] = spline_5_targets_optimal(A, W, T, num_target, R, num_robot, num_data, dt) 
    ...
    for i = 1:num_data
        ...
        [R(4), R(1), R(2), R(3)] = R(4).planPath_optimal(R(1), R(2), R(3), dt, future_frame); % path palnning
        R(4).next_poses = [];
